import {Set, Iterable, OrderedSet} from 'immutable';

/**
 * displays at most 5 items from a user list (including the ellipsis); e.g. a,b,c,d - a,b,c,d,e - a,b,c,d and 2 more
 */
export function formatUserList(title: string, users: Iterable.Set<string> |  Iterable.Indexed<string> | string[], currentUser?: string) {
  const names = [];
