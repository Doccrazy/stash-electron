...
const WelcomePage = () => (
  <div className={`${styles.body} h-100 d-flex`}>
    <div className="container h-100 d-flex flex-column">
      <div style={{ flexGrow: 1 }}>
        ...
        <p className="mb-4">
          Before you can begin storing your passwords and other secrets securely and sharing them with your team, Stash needs some
          ...
          <div className="row">
            <div className="col-md-6">
              <h2 className="text-center mb-3">
                <i className="fa fa-warning text-warning" /> Repository location
              </h2>
              <p>
                The <b>Stash repository</b> is a simple file system folder where all your secrets will be stored in strongly encrypted files
                that only authorized team members can decrypt.
              </p>
              <FormGroup>
            ...
            <div className="col-md-6">
              <h2 className="text-center mb-3">
                <i className="fa fa-warning text-warning" /> Private encryption key
              </h2>
              <p>
                The <b>private key</b> is your personal asymmetric encryption key that protects access to your secrets.
                <br />
                You may either reuse an existing private key (e.g. SSH, Putty, Github), or generate a new keypair.
              </p>
              <p>
                For added security, you should always <b>protect your key</b> with a passphrase, and <b>never share</b> the private part
                with anyone.
              </p>
              <FormGroup className="d-flex justify-content-between">
                ...
                <ActionButton actionCreator={openGenerate}>
                  <i className="fa fa-cog" /> Generate new keypair
                </ActionButton>
              </FormGroup>
              <FormGroup>
