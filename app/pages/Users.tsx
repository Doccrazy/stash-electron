  ...
  <div className={`container ${styles.users}`}>
    ...
    <div className={`row ${styles.actionBar}`}>
      <div className="col-auto">
        <ButtonGroup>
          <NavLink to="/users" exact className="btn btn-outline-primary">
            <Trans id="nav.users.keys" />
          </NavLink>
          <NavLink to="/users/permissions" className="btn btn-outline-primary">
            <Trans id="nav.users.permissions" />
          </NavLink>
          <NavLink to="/users/access" className="btn btn-outline-primary">
            <Trans id="nav.users.folderAccess" />
          </NavLink>
        </ButtonGroup>
        <Trans>
          {(t) => (
            <UsersHistoryButton color="link" title={t('action.common.history')}>
