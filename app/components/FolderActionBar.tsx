...
export default withTrans<Props>('action.folder')(
  ({
    ...
    <div>
      ...
      &nbsp;
      <Button disabled={!contentsEditable} onClick={onCreateNode}>
        <i className="fa fa-folder" /> {t('.create')}
      </Button>
      &nbsp;
      <Button disabled={!contentsEditable || !accessible} onClick={onCreateItem}>
        <i className="fa fa-plus-circle" /> {t('.createItem')}
      </Button>
    </div>
  )
);
