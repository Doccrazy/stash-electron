...
export default ({ editable, onRename, onDelete, onCreateNode, onCreateItem, onEditPermissions, onAddExternal, onImport }) => (<div>
  <BarsMenu>
    ...
    <a className="dropdown-item" href="#" onClick={onAddExternal}><i className="fa fa-file-o" /> Add external files</a>
    <a className="dropdown-item" href="#" onClick={onImport}><i className="fa fa-download" /> KeePass Import</a>
