...
export default ({ label, children, canExpand, expanded, accessible, onClickIcon, onClickLabel, onShiftClick }: Props) => (<div>
  <a
    href=""
    className={cx(styles.label, !accessible && styles.labelInaccessible)}
    onClick={ev => { if (ev.shiftKey) { onShiftClick(); } else { onClickLabel(); } }}
  >
    <span
