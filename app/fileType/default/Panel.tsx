...
const DefaultPanel = ({ onOpen, onSaveAs }: InnerProps) => (
  <div>
    <p>
      <Trans id="fileType.default.panel.title" />
    </p>
    <Button size="sm" onClick={onOpen}>
      <i className="fa fa-external-link" /> <Trans id="fileType.default.panel.button.open" />
    </Button>{' '}
    <Button size="sm" onClick={onSaveAs}>
      <i className="fa fa-save" /> <Trans id="fileType.default.panel.button.save" />
    </Button>
  </div>
);
